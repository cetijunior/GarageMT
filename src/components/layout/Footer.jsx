...
function Footer() {
	return (
		<footer className="bg-gradient-to-br from-red-700 via-black to-gray-900 text-white py-12  -mx-4 sm:-mx-2">
			<div className="container mx-auto flex flex-col md:flex-row justify-between items-start md:items-center px-6 space-y-10 md:space-y-0">
				{/* Footer Navigation */}
				<div className="text-center md:text-left space-y-4 md:space-y-2">
					...
					<div className="flex flex-col md:flex-row md:space-x-6 text-sm space-y-4 md:space-y-0">
						<Link
							to="/#hero"
							smooth
				...
				<div className="text-center md:text-right space-y-2">
					...
					<p className="text-sm text-gray-300">
						Email: support@brothersgarage.com
					</p>
